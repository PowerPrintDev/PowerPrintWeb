...
export default function FAQSection({ data }: FAQSectionProps) {
  ...
  return (
    <section className="w-full py-16 md:py-24 px-4 md:px-24 bg-neutral-200/50 relative overflow-clip">
      
      {/* Decorative mockups at desktop layer */}
      <div className="absolute left-[-100px] bottom-[-50px] w-[280px] h-[310px] hidden xl:block rotate-[1deg] opacity-25 pointer-events-none select-none z-0">
        <img src="/assets/67f0e9cafad48b51ae943ed51f2c03b933ee477a.png" alt="" className="w-full h-full object-cover rounded-2xl shadow-xl" />
      </div>
      <div className="absolute left-[120px] bottom-[-200px] w-[280px] h-[310px] hidden xl:block rotate-[-2.14deg] opacity-20 pointer-events-none select-none z-0">
        <img src="/assets/b1c41062b620e92fe7726e0274f898671941126c.png" alt="" className="w-full h-full object-cover rounded-2xl shadow-xl" />
      </div>
              ...
              >
                ...
                <div
                  className={`transition-all duration-300 ease-in-out overflow-hidden ${
                    isOpen ? "max-h-[200px] border-t border-neutral-100" : "max-h-0"
                  }`}
                >
